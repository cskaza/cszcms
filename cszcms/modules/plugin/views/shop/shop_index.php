<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <?php } ?>
            <?php /* Start All Product without soldout */ ?>
            <div class="panel panel-primary">
                <div class="panel-heading"><b><i class="glyphicon glyphicon-globe"></i> <?php echo $this->Csz_model->getLabelLang('shop_all_product_txt') ?></b></div>
                <div class="panel-body">
                    <?php
