...
//
//  Source code by. A simple PHP CAPTCHA script
...
class Viewcaptcha extends CI_Controller {
    ...
    function index() {
        ...
        $this->session->set_userdata('captcha_config', serialize($captcha_config));
        $this->session->unset_userdata('captcha');
        $this->session->set_userdata('captcha', $captcha_config['code']);
