    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="text-left" style="padding:30px;">
                <center><h3 class="form-signin-heading"><?= $this->lang->line('forgot_reset') ?></h3></center><br><br>
                <? if(!$success_chk){ ?>
                <div class="control-group">
                    <label class="control-label" for="email"><?php echo $this->lang->line('forgot_email'); ?>: <?=$email?></label>
                </div>
                <div class="control-group">		
