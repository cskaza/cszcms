...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i><span class="glyphicon glyphicon-globe"></span></i> <?= $this->lang->line('lang_header') ?>
            </li>
        </ol>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?= $this->lang->line('lang_header') ?>  <a role="button" href="<?=BASE_URL?>/admin/lang/new" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?= $this->lang->line('lang_addnew') ?></a></div>
