...
<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            <li class="active">
                <i><span class="glyphicon glyphicon-edit"></span></i> <?php echo $this->lang->line('shop_shipping_create') ?>
            </li>
        </ol>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo $this->lang->line('shop_shipping_create') ?> <a class="btn btn-default btn-sm" href="<?php echo $this->csz_referrer->getIndex('shop'); ?>"><span class="glyphicon glyphicon-arrow-left"></span> <?php echo $this->lang->line('btn_back'); ?></a></div>
        <h4><?php echo $this->lang->line('shop_order_detail') ?></h4>
        <?php echo $payment->order_detail ?>
        <hr>
        <?php echo form_open(BASE_URL . '/admin/plugin/shop/createShippingSave'); 
        echo form_hidden('inv_id', $payment->inv_id); ?>
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '255',
                'value' => set_value('shipping_name', '', FALSE)
            );
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '100',
                'value' => set_value('shipping_id', '', FALSE)
            );
            echo form_input($data);
            ?>			
        </div> <!-- /control-group -->
