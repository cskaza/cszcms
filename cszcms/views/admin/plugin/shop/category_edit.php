...
<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            <li class="active">
                <i><span class="glyphicon glyphicon-edit"></span></i> <?php echo $this->lang->line('shop_category_edit') ?>
            </li>
        </ol>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo $this->lang->line('shop_category_edit') ?> <a class="btn btn-default btn-sm" href="<?php echo $this->csz_referrer->getIndex('shop'); ?>"><span class="glyphicon glyphicon-arrow-left"></span> <?php echo $this->lang->line('btn_back'); ?></a></div>
        <?php echo form_open(BASE_URL . '/admin/plugin/shop/catEditSave/'.$this->uri->segment(5)); ?>
        <div class="control-group">	
            ...
            <div class="controls">
                ...
                echo form_dropdown('shop_category_main_id', $data, $category->shop_category_main_id, $att);
                ?>
            </div> <!-- /controls -->
        </div> <!-- /control-group -->
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '255',
                'value' => set_value('name', $category->name, FALSE)
            );
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '255',
                'value' => set_value('keyword', $category->keyword, FALSE)
            );
            echo form_input($data);
            ?>			
        </div> <!-- /control-group -->
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '255',
                'value' => set_value('short_desc', $category->short_desc, FALSE)
            );
            echo form_input($data);
            ?>
        </div> <!-- /control-group -->
