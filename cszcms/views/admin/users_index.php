...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?= $this->lang->line('user_header') ?>  <a role="button" href="<?=BASE_URL?>/admin/users/new" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?= $this->lang->line('user_addnew') ?></a></div>
            ...
            <table class="table table-bordered table-hover table-striped">
                <thead>
                    <tr>
                        ...
                        <th width="27%"><?php echo $this->lang->line('user_name'); ?></th>
                        <th width="35%"><?php echo $this->lang->line('user_email'); ?></th>
                        <th width="20%"></th>
                    </tr>
                </thead>
                <tbody>
