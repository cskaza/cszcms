...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo  $this->lang->line('nav_nav_header') ?>  <a role="button" href="<?php echo BASE_URL?>/admin/navigation/new" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo  $this->lang->line('navpage_addnew') ?></a></div>       
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <form id="lang_sel">
        ...
        <?php echo  form_open(BASE_URL . '/admin/navigation/save'); ?>
        <div class="row">           
            <div class="col-lg-6 col-md-6">
                <ol class="breadcrumb">
                    <li class="active">
                        <i><span class="glyphicon glyphicon-object-align-top"></span></i> <?php echo  $this->lang->line('navpage_header') ?>
                    </li>
                </ol>
                ...
                foreach ($nav as $n) { ?>
                    <li class="ui-state-default">
                        ...
                        <div style="float: right;">
                            <a href="<?php echo BASE_URL?>/admin/navigation/edit/<?php echo $n->page_menu_id?>" style="padding-left:10px;"><i class="glyphicon glyphicon-pencil"></i></a>
                            <a href="<?php echo BASE_URL?>/admin/navigation/delete/<?php echo $n->page_menu_id?>" onclick="return confirm('<?php echo $this->lang->line('delete_message')?>')" style="padding-left:10px;"><i class="glyphicon glyphicon-remove"></i></a>
                        </div>                        
                    </li>
                <?php } 
                }?>   
            ...
            <div class="col-lg-6 col-md-6">
                <ol class="breadcrumb">
                    <li class="active">
                        <i><span class="glyphicon glyphicon-object-align-top"></span></i> <?php echo  $this->lang->line('navpagesub_header') ?>
                    </li>
                </ol>
                <?php if(!empty($nav)){
                foreach ($nav as $n) { 
                                ...
                                if(is_array($drop_menu)){
                                    foreach ($drop_menu as $rs1){ ?>                              
                                            <li class="ui-state-default">
                                                ...
                                                <div style="float: right;">
                                                    <a href="<?php echo BASE_URL?>/admin/navigation/edit/<?php echo $rs1->page_menu_id?>" style="padding-left:10px;"><i class="glyphicon glyphicon-pencil"></i></a>
                                                    <a href="<?php echo BASE_URL?>/admin/navigation/delete/<?php echo $rs1->page_menu_id?>" onclick="return confirm('<?php echo $this->lang->line('delete_message')?>')" style="padding-left:10px;"><i class="glyphicon glyphicon-remove"></i></a>
                                                </div>                                                
                                            </li>  
                                    <?php }
                                } ?>
